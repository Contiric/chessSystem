...
public class Board {
	...
	// Método retirado para indicar que o tabuleiro não pode ser alterado após a
	// criação, programação defensiva
...
//	}
	...
	//Método responsável por colocar a peça no tabuleiro numa dada posição
	...
	// Método para verificar se a posição existe passando a posição como argumento
