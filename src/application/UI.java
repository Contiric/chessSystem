...
public class UI {
	...
	// Códigos especiais das cores para serem exibidas na console
	...
	// Método para ler a posição do xadrez
	...
	private static void printPiece(ChessPiece piece, boolean background) {
    	...
    	if (piece == null) {
    		...
    		// Condição para determinar a cor da peça	
	...
	private static void printCapturedPieces(List<ChessPiece> captured) {
		...
		System.out.println("Captured Peices:");
